...
TO_RECIPIENTS = ["customs.phl@savinodelbene.com","isf.southeast@savinodelbene.com"]
CC_RECIPIENTS = ["ying@earthrated.com","kadyn.pease@savinodelbene.com"]
